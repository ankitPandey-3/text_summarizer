        ...
        <div className="bg-gray-100 flex gap-10 md:gap-0 md:justify-center flex-col md:flex-row items-center h-screen">
            ...
            <div className="lg:p-36 md:p-52 sm:p-20 p-8 w-full lg:w-1/2 flex flex-col justify-center items-center ">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    <button
                        className="bg-blue-500 hover:bg-blue-600 font-semibold rounded-md py-2 md:py-4 px-10 md:px-16 w-full lg:w-auto text-white text-base md:text-xl font-serif lg:whitespace-nowrap"
                        id="signup"
                        onClick={handleClick}
                    >
                        Sign Up
                    ...
                    <button
                        className="bg-blue-500 hover:bg-blue-600 font-semibold rounded-md py-2 md:py-4 px-10 md:px-16 w-full lg:w-auto mt-4 lg:mt-0 text-white text-base md:text-xl font-serif"
                        id="login"
                        onClick={handleClick}
                    >
                        Login
