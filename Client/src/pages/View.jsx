...
export const View = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        const textHandler = async () => {
            try {
                ...
                setSummary(response.data.data.generatedText);
            } catch (error) {
                            ...
                            <div className="container w-full">
                                ...
                                <header className="flex justify-between items-center mb-8 w-full py-4 px-4 bg-yellow-400 border-none">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-white text-base lg:text-2xl ml-9 font-bold font-serif">
                                            {title}
                                        </div>
                                    </div>
                                    {/* Action buttons */}
                                ...
                                <div className="flex justify-center items-center">
                                    <div className="text-black text-base lg:text-2xl ml-9 font-bold font-serif">
                                        Original Content
                                    </div>
                                </div>
                                <div>
                                    <div className="md:flex md:items-center">
                                        ...
                                        >
                                            <textarea
                                                className="w-3/4 h-96 px-3 py-2 border rounded mb-4 font-serif text-orange-800 lg:ml-14 mr-2 ml-4 mt-4"
